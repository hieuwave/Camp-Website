   ...
   relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      ...
      justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px] ">
        <CampSite 
          ...
          title="Da Nang Camp"
          subtitle="Da Nang, Hieu"
          peopleJoined="27+ Joined"
        />
        <CampSite 
          backgroundImage="bg-bg-img-2"
          title="Son Tra Camp"
          subtitle="Ban Dao Son Tra"
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-20 lg:mr-6">
        ...
        xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl" >
          <h2 className="regular-24 md:regular-32 2xl:reguler-64 capitalize text-white ">
            <strong>Missing Home</strong> And Want To Go Home?
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">Try your best, then make your parents proud!!!
          </p>
